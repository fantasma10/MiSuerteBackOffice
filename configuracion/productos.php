        ...
        <div class="contentwrappers">
			...
			<div class="panel panel-default toggle panelMove panelClose panelRefresh" id="supr6"> 
				<div class="panel-heading">
					<h4 class="panel-title">Registro de Productos</h4>
				...
				<div class="panel-body"> 
					<div class="row">
						<div class="col-xs-2">
							<div class="form-group">
								<label>Familia</label>
								<select class="form-control" id="cmbFamilias" name="nIdFamilia" onchange="cargarsubfamlias(this.value)">
						...
						<div class="col-xs-2"> 
							<div class="form-group" id="div-regimenfiscal">
								...
								<select class="form-control" id="cmbsubfamilia" name="cmbSubfamilia" >
									<option value="-1">--</option>
						...
						<div class="col-xs-4">
							<div class="form-group" id="div-regimenfiscal">
								<label>Emisor </label>
								<input class="form-control" id="txtEmisor" maxlength="150" name="sEmisor"/>
                                <input type="hidden" id="idemisor" name="nIdEmisor" maxlength="150" name="sEmail"/>
							</div>
						</div>
					...
					<div class="row"> 
                         ...
                         <div class="col-xs-2">
							<div class="form-group">
								<label>Abrev. Producto</label>
								<input class="form-control" id="txtabrev" maxlength="10" name="sAbrev"/>
							</div>
						</div>
						<div class="col-xs-2">
							<div class="form-group">
						...
						<div class="col-xs-2">
							<div class="form-group">
								<label>Flujo de Importe</label>
								<select class="form-control" id="cmbflujo">
									<option value="-1">--</option>
                    ...
                    <div class="row"> 
						<div class="col-xs-2">
							<div class="form-group">
								...
								<input class="form-control " id="txtPorComProd" maxlength="10" name="sPorComProd"/>
							</div>
						</div>
						<div class="col-xs-2">
							<div class="form-group">
                        ...
                        <div class="col-xs-2">
							<div class="form-group">
								<label>$ Comisi&oacute;n Cliente</label>
								<input class="form-control " id="txtImpComCte" maxlength="10" name="sImpComCte"/>
							</div>
						</div>
                        <div class="col-xs-2">
							<div class="form-group">
								<label>% Comisi&oacute;n Usuario</label>
								<input class="form-control " id="txtPorComUsr" maxlength="10" name="sPorComUsr"/>
							</div>
						</div>
                        <div class="col-xs-2">
							<div class="form-group">
								<label>$ Comisi&oacute;n Usuario</label>
								<input class="form-control " id="txtImpComUsr" maxlength="10" name="sImpComUsr"/>
							</div>
						</div>
                     ...
                     <div class="row"> 
						 <div class="col-xs-12"> 
                             <br/>
				            <h5>Servicios por Familia Seleccionada</h5>
                             <br/>
				         </div> 
					</div> 
                    ...
                    <div class="row"  >     
                                ...
                                <div class="col-xs-2 "> 
                                  <div class="form-group" id="divestatus1">
								    <label>SKU</label>
								    <input class="form-control " id="txtsku" disabled="disabled"/>
							     </div>
                               ...
                               <div class="col-xs-8 "> 
                                   <div class="pull-right"> 
                                       ...
                                       <a href="#" class="btn btn-info btn-xs editar" id="btneditarprod" onclick="validarform(2)">Guardar Cambios</a>
...
<h3>Productos Registrados</h3><span id="nuevospn" class="rev-combo pull-right">Nuevo<br>Producto</span></div>
