...
<script src="../css/ui/jquery.ui.menu.js"></script>
    ...
    <script src="../inc/js/jquery.mask.min.js" ></script>
     ...
     <script src="./js/emisores.js" ></script>
        ...
        <div class="contentwrappers">
			...
			<div class="panel panel-default toggle panelMove panelClose panelRefresh" id="supr6"> 
				<div class="panel-heading">
					<h4 class="panel-title">Registro de Emisores</h4>
					...
					<div class="row">
						...
						<div class="col-xs-3"> 
							<div class="form-group" id="div-regimenfiscal">
								...
								<input class="form-control" id="txtabrev" maxlength="150" name="sEmisor"/>
...
<h3>Emisores Registrados</h3><span id="nuevospn" class="rev-combo pull-right">Nuevo<br>Emisor</span></div>
