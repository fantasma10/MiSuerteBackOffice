...
$usr        = $_POST['usr'];
	...
	$sQuery = "CALL redefectiva.SP_UPDATE_RUTA('$ruta','$desc','$prod', '$prov',  '$con','$sku',  '$max','$min', '$ini', '$fin',   '$porcostrut', '$impcostrut',  '$porcomprod', '$impcomprod',  '$porcomusr', '$impcomusr', '$porcomcte', '$impcomcte', '$usr');";
