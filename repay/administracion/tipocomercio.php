...
<html lang="es">
                                ...
                                <div class="wizard">
                                    <div class="wizard-inner">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li id="btnAgregarTipoComercio" role="presentation" class="" data-tipocomercio="1">
                                            ...
                                            <li id="btnDatosTipoComercioEditar" role="presentation" class="disabled" data-tipocomercio="2">
                                            ...
                                            <li id="btnEliminar" role="presentation" class="disabled" data-tipocomercio="3">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" role="tabpanel" id="step1" style="margin-button:20px;">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <h4><span><i></i></span> Listado de Tipos de Comercio</h4>
                                            </div>
                                                    ...
                                                    <table id="data" class="display table table-bordered table-striped" style=" width: 100%; display:none;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Nombre del Tipo de Comercio</th>
                                                                <th>Estatus</th>
                                                                <th id="">Fecha Registro</th>
                                                                <th id="">Fecha Movimiento</th>
                                                            </tr>
                                                        </thead>	
                                                        <tbody>
                                                            <!--Aqui se enlistan los datos del tipo de comercio, de manera dinamica-->
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            <div class="form-group col-lg-12">
                                                <h4><span><i class="fa fa-file-text"></i></span> Agregar un Tipo de Comercio</h4>
                                            </div>

                                            <div class="form-group col-xs-12">

                                                <div class="form-group col-xs-3">
                                                    <label class=" control-label">Nombre de Tipo de Comercio: </label>
                                                    <input type="text" class="form-control m-bot15" name="" id="nombreTipocomercio">
                                                </div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step3">
                                            <div class="form-group col-lg-12">
                                                <h4><span><i class="fa fa-file-text"></i></span> Modificar un Tipo de Comercio</h4>
                                            </div>
                                            ...
                                            <div class="form-group col-xs-12">
                                                ...
                                                <div class="form-group col-xs-3">
                                                    ...
                                                    <label class=" control-label">ID del Tipo de Comercio: </label>
                                                    <input type="text" class="form-control m-bot15" name="" id="idTipoComercioEdit" disabled>
                                                </div>
                                                <div class="form-group col-xs-3">
                                                    <label class=" control-label">Nombre del Tipo de Comercio: </label>
                                                    <input type="text" class="form-control m-bot15" name="" id="nombreTipocomercioEdit">
                                                </div>
                                            ...
                                            <ul class="list-inline pull-right">
                                                <li><button type="button" class="btn btn-default prev-step" id="btnCancelar">Cancelar</button></li>
                                                <li><input id="btnEditar" type="button" class="btn btn-primary " value="Guardar" ></li>
                                            </ul>
    ...
    <script src="<?php echo $PATHRAIZ; ?>/repay/administracion/js/tipocomercio.js"></script>
    <script type="text/javascript">

        BASE_PATH = "<?php echo $PATHRAIZ; ?>";
        $(document).ready(function () {
            initViewTipocomercio();
