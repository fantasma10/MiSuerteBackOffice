...
$submenuTitulo = "Comercio";
$subsubmenuTitulo = "Comercio";
$tipoDePagina = "mixto";
$idOpcion = 281;
...
<html lang="es">
                ...
                <div class="col-lg-12">
                    <div class="panelrgb">
                        <div class="titulorgb-prealta">
                            ...
                            <h3>Cat&aacute;logo de comercios</h3>
                                ...
                                <div class="wizard">
                                    <div class="wizard-inner">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li id="btnConsultar" role="presentation" class="active" data-comercio="0">
                                            ...
                                            <li id="btnAgregarComercio" role="presentation" class="" data-comercio="1">
                                            ...
                                            <li id="btnDatosComercioEditar" role="presentation" class="disabled" data-comercio="2">
                                            ...
                                            <li id="btnEliminar" role="presentation" class="disabled" data-comercio="3">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" role="tabpanel" id="step1" style="margin-button:20px;">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <h4><span><i></i></span> Listado de Comercios</h4>
                                            </div>
                                            <div id="gridboxExport" class="adv-table table-responsive">
                                                ...
                                                <div id="gridbox" class="adv-table table-responsive" >
                                                    <table id="data" class="display table table-bordered table-striped" style=" width: 100%; display:none;">
                                                        ...
                                                        <tbody>
                                                            <!--Aqui se enlistan los datos del comercio, de manera dinamica-->
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <!--Panel para agregar un comercio-->

                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            <div class="form-group col-lg-12">
                                                <h4 id="tituloAgregar"><span><i class="fa fa-file-text"></i></span> Agregar un Comercio</h4>
                                                <h4 id="tituloEditar" style="display: none;"><span><i class="fa fa-file-text"></i></span> Editar un Comercio</h4>
                                            </div>
                                            <form id="frmComercio">
                                                <input type="hidden" class="form-control m-bot15" id="tipo" name="tipo" value="2" />
                                                <input type="hidden" class="form-control m-bot15" name="idComercio" id="idComercio" />
                                                <div class="form-group col-xs-12">

                                                    <div class="form-group col-xs-6">
                                                        <label class=" control-label">Tipo de Comercio: </label>
                                                        <select class="form-control m-bot15" name="cmbTipoComercio" id="cmbTipoComercio"></select>
                                                    </div>
                                                    <div class="form-group col-xs-6">
                                                        <label class=" control-label">Nombre del Comercio: </label>
                                                        <input type="text" class="form-control m-bot15" name="nombreComercio" id="nombreComercio">
                                                    </div>
                                                ...
                                                <div class="form-group col-xs-12">
                                                    ...
                                                    <div class="form-group col-xs-6">
                                                        ...
                                                        <input type="text" class="form-control m-bot15" name="razonSocial" id="razonSocial">
                                                    </div>
                                                    <div class="form-group col-xs-6">
                                                        <label class=" control-label">RFC: </label>
                                                        <input type="text" class="form-control m-bot15" name="sRFC" id="sRFC" onkeyup="validaRFC(this.value)" style="text-transform: uppercase;">
                                                    </div>
                                                </div>

                                                <div class="form-group col-xs-12" id="verToken" style="display:none;">

                                                    <div class="form-group col-xs-6">
                                                        <label class=" control-label">Token: </label>
                                                        <input type="text" class="form-control m-bot15" name="sTokenEditar" id="sTokenEditar" disabled="">
                                                    </div>                                                            
                                                </div>
                                            </form>
    ...
    <script src="<?php echo $PATHRAIZ; ?>/repay/administracion/js/comercio.js"></script>
