...
<html lang="es">
    <head>
        ...
        <title>.::Mi Red::.Tipo Contacto</title>
        <!-- Núcleo BOOTSTRAP -->
                ...
                <div class="col-lg-12">
                    <div class="panelrgb">
                        <div class="titulorgb-prealta">
                            ...
                            <h3>Cat&aacute;logo de Tipo de Contacto</h3>
                                ...
                                <div class="wizard">
                                    <div class="wizard-inner">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li id="btnConsultar" role="presentation" class="active" data-tipocontacto="0">
                                            ...
                                            <li id="btnAgregarTipoContacto" role="presentation" class="" data-tipocontacto="1">
                                            ...
                                            <li id="btnDatosTipoContactoEditar" role="presentation" class="disabled" data-tipocontacto="2">
                                            ...
                                            <li id="btnEliminar" role="presentation" class="disabled" data-tipocontacto="3">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" role="tabpanel" id="step1" style="margin-button:20px;">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <h4><span><i></i></span> Listado de Tipos de Contacto</h4>
                                            </div>
                                            <div id="gridboxExport" class="adv-table table-responsive">
                                                ...
                                                <div id="gridbox" class="adv-table table-responsive" >
                                                    <table id="data" class="display table table-bordered table-striped" style=" width: 100%; display:none;">
                                                        ...
                                                        <tbody>
                                                            <!--Aqui se enlistan los datos de los tipos de contacto, de manera dinamica-->
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            <div class="form-group col-lg-12">
                                                <h4 id="tituloAgregar"><span><i class="fa fa-file-text"></i></span> Agregar un tipo de contacto</h4>
                                                <h4 id="tituloEditar" style="display: none;"><span><i class="fa fa-file-text"></i></span> Editar un tipo de contacto</h4>
                                            </div>
                                            <form id="frmTipoContacto">
                                                ...
                                                <div class="form-group col-xs-12">
                                                    ...
                                                    <div class="form-group col-xs-4" id="verIdTipoContacto" style="display: none">
                                                        <label class=" control-label">ID Tipo contacto:  </label>
                                                        <input class="form-control m-bot15" name="nTipoContacto" id="nTipoContacto" disabled/>
                                                    </div>

                                                    <div class="form-group col-xs-4">
                                                        <label class=" control-label">Descripcion: * </label>
                                                        <input class="form-control m-bot15" name="sNombre" id="sNombre"/>
                                                    </div>
    ...
    <script src="<?php echo $PATHRAIZ; ?>/repay/administracion/js/tipoContacto.js"></script>
    <script type="text/javascript">

        BASE_PATH = "<?php echo $PATHRAIZ; ?>";
        $(document).ready(function () {
            initViewTipoContacto();
