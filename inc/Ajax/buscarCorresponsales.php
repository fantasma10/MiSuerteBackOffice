...
$funcion2 = (isset($_POST['funcion2']))? ""/*"window.setTimeout(\"".$_POST['funcion2']."\",100);"*/:"";
        ...
        $d = "";
        if($res != null){
				$d = "<select id='ddlCorresponsal' class='form-control m-bot15' onchange='$funcion2;ClearScreen();'>
                        <option value='-2' onclick='$funcion2;' selected='selected'></option>
                        <option value='-1' onclick='$funcion2;'>Todos</option>";
            ...
            echo "<select id='ddlCorresponsal' class='form-control m-bot15'><option value='-1'></option></select>";
        }
		$band = false;
        ...
        $d = "";
        if($res != null){
            $d = "<select id='ddlCorresponsal' class='form-control m-bot15' onchange='$funcion2;ClearScreen();'><option value='-1'></option>";
            ...
            echo "<select id='ddlCorresponsal' class=form-control m-bot15'><option value='-2' selected='selected'></option>
        <option value='-1' >Todos</option></select>";
        }
}else{ echo "<select id='ddlCorresponsal' class='form-control m-bot15'><option value='-2' selected='selected'></option>
        <option value='-1' >Todos</option></select>";}
