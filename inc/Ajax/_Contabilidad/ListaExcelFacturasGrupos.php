<?php
	...
	*/
	...
	$sql = "CALL data_contable.SP_FACTURAS_GRUPOS_LOAD($tipoDocumento,'$noFactura','$numeroCuenta','$fechaFactura', '$fechaInicio','$fechaFin',$idEstatus, $start, $limit, $colsort, '$ascdesc', '$strToFind', $idTipoProveedor, 0, $corte, $idGrupo, '$RFC')";
