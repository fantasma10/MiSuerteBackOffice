<?php
	...
	$idAcreedor	= (!empty($_GET['idAcreedor']))? $_GET['idAcreedor'] : 0;
	...
	$query = "CALL `data_contable`.`SP_INSTRUCCION_PROVEEDOR_LOAD`($idAcreedor, '$numCuenta', '$idEstatus', '$idTipoInstruccion', '$fechaInicio', '$fechaFinal', '$colsort', '$ascdesc', '$strToFind', '$actual', '$cant')";
