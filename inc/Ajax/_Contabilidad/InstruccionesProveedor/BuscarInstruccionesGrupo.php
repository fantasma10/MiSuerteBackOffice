<?php
	...
	$query = "CALL `data_contable`.`SP_INSTRUCCION_GRUPO_LOAD`($idGrupo, '$numCuenta', '$idEstatus', '$idTipoInstruccion', '$fechaInicio', '$fechaFinal', '$colsort', '$ascdesc', '$strToFind', '$actual', '$cant')";
