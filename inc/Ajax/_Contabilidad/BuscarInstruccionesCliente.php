<?php
	...
	$query = "CALL `data_contable`.`SP_INSTRUCCION_CLIENTE_LOAD`($idCliente, '$numCuenta', '$idEstatus', '$idTipoInstruccion', '$fechaInicio', '$fechaFinal', '$colsort', '$ascdesc', '$strToFind', '$actual', '$cant')";
