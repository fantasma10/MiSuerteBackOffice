<?php
	...
	$sql = "CALL data_contable.SP_FACTURAS_CLIENTES_LOAD($tipoDocumento,'$noFactura','$numeroCuenta','$fechaFactura', '$fechaInicio','$fechaFin',$idEstatus, $actual, $cant, $colsort, '$ascdesc', '$strToFind', $idTipoProveedor, 0, $corte, $idCadena, $idSubCadena, $idCorresponsal, '$RFC')";
	//var_dump("sql: $sql");
