<?php
	...
	*/
	...
	$sql = "CALL data_contable.SP_AUTORIZACION_LOAD3($tipoPago, '$noFactura', '$fechaFactura', '$RFC', '$numeroCuenta', $idEstatus, $start, $limit, $colsort, '$ascdesc', '$strToFind')";
	//var_dump($sql);
