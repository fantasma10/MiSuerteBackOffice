...
if(isset($_POST['idpais'])){
	...
	$d = "";
	if($res != NULL){
		$d = "<select id='ddlMunicipio' name='ddlMunicipio' class='form-control m-bot15' onchange='buscaSelectColonia($j, \"$funcion1\"); $funcion1'><option value='-2'>Seleccione un Cd</option>";
		...
		echo "<select id='ddlMunicipio' name='ddlMunicipio' class='form-control m-bot15' ><option value='-2'>Seleccione un Edo (Error)</option></select>";
	}
}
?>