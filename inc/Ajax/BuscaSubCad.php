...
if(isset($_POST['idcad'])){
	...
	$d = "";
	if($res != null){
		$d = "<select id='ddlSubCad' class='form-control m-bot15' onchange='buscarCorresponsal(".$j.");$funcion2' $desabilitar><option value='-2' selected='selected'>Todos</option>";
		...
		echo "<select id='ddlSubCad' class='form-control m-bot15'><option value='-2' selected='selected'>Todos</option></select>";
	}
}else{ echo "<select id='ddlSubCad' class='form-control m-bot15'><option value='-2' selected='selected'>Todos</option></select>";}
?>