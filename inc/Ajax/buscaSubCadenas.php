...
if(isset($_POST['idcad'])){
	...
	$d = "";
	if($res != null){
		$d = "<select id='ddlSubCad' class='form-control m-bot15' onchange='buscarCorresponsales(".$j.");$funcion2' $desabilitar>
		...
		echo "<select id='ddlSubCad' class='form-control m-bot15'><option value='-2' selected='selected'></option>
		<option value='-1' >Todos</option></select>";
	}
}else{ echo "<select id='ddlSubCad' class='form-control m-bot15'><option value='-2' selected='selected'></option>
		<option value='-1' >Todos</option></select>";}
?>