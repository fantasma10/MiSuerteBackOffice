...
if ( $debeCrearsePreCargo ) {
	$oPreCargoSubCadena = new PreCargo($LOG, $WBD, $RBD, $idPreCargo, $tipoConcepto, $cadenaID, $subcadenaID, -1, $importe, $fechaInicio, $observaciones, "", 0, "", 0, $configuracion, $_SESSION['idU']);
