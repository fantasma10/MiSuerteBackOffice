...
$oPreCargo = new PreCargo($LOG, $WBD, $RBD, $idPreCargo, $tipoConcepto, $cadenaID, -1, -1, $importe, $fechaInicio, $observaciones, "", 0, "", 0, $configuracion, $_SESSION['idU']);
$preCargo = $oPreCargo->actualizarCargo();

$oCadena = new XMLPreCadena($RBD,$WBD);
$oCadena->load($_SESSION['idPreCadena']);

if ( !$preCargo["error"] ) {
	echo "0|Cargo editado";
} else {
	echo "1|".$preCargo["msg"].$preCargo["errmsg"];
}    
?>