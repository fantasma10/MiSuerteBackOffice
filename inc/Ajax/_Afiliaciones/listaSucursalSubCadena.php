<?php
	...
	$idSubCadena	= (isset($_REQUEST['idSubCadena']))	? $_REQUEST['idSubCadena']	: -1;
	...
	$QUERY = "CALL `afiliacion`.`SP_SUCURSAL_LISTA`(0, $colsort, '$ascdesc', '$strToFind', $start, $limit, $idSubCadena);";
