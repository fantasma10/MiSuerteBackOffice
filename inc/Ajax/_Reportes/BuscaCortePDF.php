...
if(($idCadena >= 0)&&($idSubCadena >= 0)&&($idCorresponsal < 0)){//echo 'SubCadena'; validaciones traídas del documento BuscaCorte
//if(($idCadena > 0)&&($idSubCadena >= 0)&&($idCorresponsal == -1)){//echo 'SubCadena'; VALIDACIONES ORIGINALES DE ESTE DOCUMENTO
	$IDENT	= 2;
	$AND	=" 	AND `idCadena` = $idCadena
				AND `idSubCadena` = $idSubCadena";
}
if(($idCadena >= 0)&&($idSubCadena < 0)&&($idCorresponsal < 0)){//echo 'Cadena'; validaciones traídas del documento BuscaCorte
//if(($idCadena > 0)&&($idSubCadena == -1)&&($idCorresponsal == -1)){//echo 'Cadena'; VALIDACIONES ORIGINALES DE ESTE DOCUMENTO
	$IDENT		= 3;
	$AND		= "	AND `idCadena` = $idCadena";
}
...
$data.='<table border="0" width="650" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td rowspan="2" colspan="3" align="left"><span style="font-weight:bold;font-size:30px;">Red Efectiva</span></td><td colspan="2" align="right"><span style="font-weight:bold;font-size:27px;">Red Efectiva S.A. de C.V.</span></td>
	</tr>
	<tr>
		<td colspan="2" align="right"><span style="font-size:24px;">Blvd. Antonio L. Rdz 3058 Suite 201-A</span></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;color:#555;">REPORTE CONDENSADO DE MOVIMIENTOS</span></td><td colspan="2" align="right"><span style="font-size:24px;">Colonia Santa Maria</span></td>
	</tr>
	<tr>
		<td colspan="3"></td><td colspan="2" align="right"><span style="font-size:24px;">Monterrey, N.L. C.P. 64650</span></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:23px;">'.$direccion.'</span></td><td colspan="2"></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:23px;">'.$colonia.'</span></td><td><span style="font-weight:bold;">Tipo: Corte</span></td><td><span style="font-weight:bold;">Corresponsal</span></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:23px;">'.$munest.'</span></td><td colspan="2"><span style="font-weight:bold;">Periodo de </span><span style="font-weight:bold;color:#555;">'.$finix.'</span> <span style="font-weight:bold;">a</span> <span style="font-weight:bold;color:#555;">'.$ffin.'</span></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:23px;">'.$cp.'</span></td><td colspan="2"></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:23px;">'.$pais.'</span></td><td colspan="2"></td>
	</tr>
...
$data.='<tr>
	...
	<tr>
		...
		$DIF=($entTOTAL-$salTOTAL);
	       $data.='
			       <tr>
				       <td colspan="4" align="right"><span style="font-weight:bold;color:#006;font-size:28px;">Diferencia de entradas y salidas&nbsp;</span></td>
				       <td align="right" ';
	...
	<tr>
		<td colspan="5" class="Cuerpo" align="right">
			<span style="font-weight:bold;font-size:26px;">Una diferencia negativa ( - ) significa a favor del corresponsal</span>
		</td>	 
	</tr></table>';
	$seccion = "Cortes";
