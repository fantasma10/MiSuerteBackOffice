...
$DIF			= 0;
	...
	//var_dump("CALL SP_LOAD_CORTES('$finix', '$ffin', '$AND')");
	$Result3 	= $RBD->query("CALL SP_LOAD_CORTES($idCadena, $idSubCadena, $idCorresponsal, '$finix', '$ffin')");
	//var_dump("CALL SP_LOAD_CORTES($idCadena, $idSubCadena, $idCorresponsal, '$finix', '$ffin')");
	$sf = 0;
	echo $RBD->error();
	$fg = 0;
...
$data.='<table border="0" width="650" style="max-width:650px !important; margin-top:40px;" cellpadding="0" cellspacing="0" align="center">
	<tr>
	...
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:13px;">'.$colonia.'</span></td><td><span style="font-weight:bold;">Tipo Corte</span></td><td><span style="font-weight:bold;">Corresponsal</span></td>
	</tr>
	<tr>
		<td colspan="3" align="left"><span style="font-weight:bold;font-size:13px;">'.$munest.'</span></td><td colspan="2"><span style="font-weight:bold;">Periodo de </span><span style="font-weight:bold;color:#555;">'.$finix.'</span> <span style="font-weight:bold;">a</span> <span style="font-weight:bold;color:#555;">'.$ffin.'</span></td>
	</tr>
	<tr>
