...
class PolizaMovimiento{
	...
	public function guardar(){
		...
		$this->oWdb->setSStoredProcedure('sp_insert_polizamovimiento');
		if(!empty($this->customParams)){
			$array_params = self::getCustomParams();
			$array_params[0]['value'] = self::getNIdPoliza();
	...
	public function cargar(){
		...
		$this->oWdb->setSDatabase($sDatabase);
		$this->oWdb->setSStoredProcedure('sp_select_polizalayoutmovimientos');
		$this->oWdb->setParams($array_params);
		$resultado = $this->oWdb->execute();
