...
function initComponents(){
	...
	tipoRFC = 0;
	$("[name='razonSocial']").on('keyup', function(){
	...
	$("[name='nombrePersona'], [name='apPPersona'], [name='apMPersona']").on('keyup', function(){
		var valor = event.target.value;
