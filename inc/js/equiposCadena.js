...
$("#consultar").on("click", function(){
	...
	if (document.getElementById("idCadena").value == "") {
		alert("Debes seleccionar una Cadena.");
	}else{
		cargarReporte();
	}
...
function suspenderEquipo(idEquipo){
	...
	alert("idCadena: " + idCadena);
	
	var nombreCadena = $("#cadena option:selected").html();
	...
	llenaDataTableMov("reporteResumenDT", params, BASE_PATH + "/inc/Ajax/_Administracion/AdministraEquiposCadena.php");
}
...
function cargarReporte() {
	...
	getCadena("reporteResumenDT", params, "../../inc/Ajax/_Administracion/AdministraEquiposCadena.php");
}

function cambiaEstatus(idEquipo, idCorr){
	
	$.post("../../inc/Ajax/_Administracion/ActualizarEstatusEquipoCadena.php", { idEquipo: idEquipo, idCadena: idCorr}, 
	function(respuesta){
...
function getCadena(id, obj, url){
		
		$('#'+id).dataTable({
			"iDisplayLength"	: 10,
			"bProcessing"		: false,
			"bServerSide"		: true,
			"sAjaxSource"		: "../../inc/Ajax/_Administracion/AdministraEquiposCadena.php",
...
function verCadena( idCadena ) {
	$("#formBusquedaCadena [id='idCadena']").val( idCadena );
	if ( idCadena == -1 || idCadena == 0 || idCadena == "" || idCadena == undefined ) {
		alert("Seleccione un Cliente");
	} else {
		$("#formBusquedaCadena").submit();
	}
}

function irANuevaBusqueda(){
	window.location = BASE_PATH + "/_Cliente/Cadena.php";
}

function llenaDataTableConsultaCadena(id, obj, url){
