<div id="btnRegresar" class="btnRegresar">
	<?php
		if(isset($_POST['hRutaX']) && $_POST['hRutaX'] != ""){
	?>
		<form action="<?php echo $_POST['hRutaX']; ?>" method="post">
    		...
    		<input type="hidden" id="hHaceUnaSemX" name="hHaceUnaSemX" value="<?php echo isset($_POST['hHaceUnaSemX'])?$_POST['hHaceUnaSemX']:date('Y-m-d', strtotime('-1 week')); ?>" />
            	<input type="image" id="Regresar" value="" src="../../img/btn_regresar1.png" style="border: 0px;" />
		</form>  
	<?php
		}
	?>
