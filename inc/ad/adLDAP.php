...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@redefectiva.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=redefectiva,DC=local"; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.10.1.2");
    ...
    * @var string
    */
	//protected $adminUsername = "readmin";
    //protected $adminPassword = "4guA9Gre3n";
	protected $adminUsername = "SysAdmin";
	protected $adminPassword = "REx4en1o17Sys";
    //protected $adminPassword = "4guA9Gre3n17";
