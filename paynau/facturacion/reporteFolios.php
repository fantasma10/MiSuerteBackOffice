...
<head>
	...
	<title>.::Mi Red::.Reporte Folios</title>
	<!-- Núcleo BOOTSTRAP -->
                ...
                <div class="form-group col-xs-12">
                    <div id="gridboxExport" class="adv-table table-responsive">
                        <div id="gridbox" class="">
                            <table id="foliosFacturas" class="display table table-bordered table-striped" style="width: 100%;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Saldo en folios</th>
                                        <th>Vigencia folios</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script src="<?php echo $BASE_PATH;?>/paynau/js/facturacion/reporteFolios.js?<?php echo rand() ?>"></script>
