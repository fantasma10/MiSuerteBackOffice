...
<head>
	...
	<title>.::Mi Red::.Reporte Operaci&oacute;n</title>
	<!-- Núcleo BOOTSTRAP -->
            ...
            <div class="panel-body">
                        ...
                        <div id="gridbox" class="">
                            <table id="ventaFolios" class="display table table-bordered table-striped" style="width: 100%;">
                                <thead>
                                    ...
                                    <th>Razon Social</th>
                                    <th>RFC</th>
                                    <th>Cantidad CFDI´s</th> 
                                    <th>Precio U. Compra</th>
                                    <th>Costo de Proveedor CFDI</th>
                                    <th>Precio U. Venta</th>
                                    <th>Total CFDI´s</th>                                    
                                    <th>Medio de Pago</th>
                                    <th>Comisión Metodo (costo)</th>
                                    <th>Comisión Metodo de pago (Cobrado)</th>
                                    <th>Total Cobrado</th>
                ...
                <div class="well" id="div_Exportar" style="display: none;">
                    <div class="form-group col-xs-2" style="padding-left:40px;">
                        <form method="post" id="exportar_excel" action="../../ajax/facturacion/reporteOperacionesExcel.php">
                            <input type="hidden" name="fechaIni_excel" id="fechaIni_excel" >
                            <input type="hidden" name="fechaFin_excel" id="fechaFin_excel" >
                            <input type="hidden" name="nIdProveedor_excel" id="nIdProveedor_excel" >
                            <input type="hidden" name="nIdEmpresa_excel" id="nIdEmpresa_excel" >
                    ...
                    <div class="form-group col-xs-2" style="padding-left:40px;">
                        <form method="post" id="exportar_PDF" target="_blank" action="../../ajax/facturacion/reporteOperacionesPDF.php">
                            <input type="hidden" name="fechaIni_pdf" id='fechaIni_pdf'>
                            <input type="hidden" name="fechaFin_pdf" id='fechaFin_pdf'>
                            <input type="hidden" name="nIdProveedor_pdf" id='nIdProveedor_pdf'>
                            
                            
                            <input type="hidden" id='h_ExportPdf' value="1" name="h_ExportPdf">
...
<script src="<?php echo $BASE_PATH;?>/paynau/js/facturacion/operaciones.js?<?php echo rand() ?>"></script>
