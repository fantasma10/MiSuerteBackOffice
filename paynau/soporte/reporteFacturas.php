    ...
    <section class="wrapper site-min-height">
        <div class="panel panelrgb">
            <div class="titulorgb-prealta">
                ...
                <h3>Reporte de uso de CFDI´s </h3>
            ...
            <div class="panel-body">
                <div class="well" id="divBusqueda">
                   <div class="row">
                    ...
                    <div class="row" id="busquedaFiltro" style="display: none;">
                        ...
                        <div class="form-group col-xs-3" id="divEmpresas" style="display: none;">
                            <label class="control-label">Empresa:</label>
                            <select id="cmbEmpresas" class="form-control m-bot15"></select>
                        </div>
                    </div>
                </div>                
                ...
                <div class="form-group col-xs-12">
                    <div id="gridboxExport" class="adv-table table-responsive">
                        <div id="gridbox" class="">
                            <table id="foliosFacturas" class="display table table-bordered table-striped dataTable" style="width: 100%;">
                ...
                <div class="well" id="div_Exportar" style="display: none;">
                    <form method="post" id="exportar_excel" action="../../ajax/facturacion/reporteFoliosExcel.php">
...
<script src="<?php echo $BASE_PATH;?>/inc/js/jquery.min.js"></script>
...
<!-- <script src="<?php echo $BASE_PATH;?>/paynau/js/jQuery/jquery.min.js"></script> -->
<script src="<?php echo $BASE_PATH;?>/paynau/js/soporte/reporteFacturas.js?<?php echo rand() ?>"></script>
