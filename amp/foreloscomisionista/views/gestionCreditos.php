...
<html lang="es">
                ...
                <div class="col-lg-12">
                    <div class="panelrgb">
                        <div class="titulorgb-prealta">
                            ...
                            <h3>Créditos de los comisionistas</h3>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="wizard">
                                    ...
                                    <div class="col-4 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <label for="statusCredito" class="control-label">Estado de Crédito</label>
                                        <select  id="statusCredito" name="statusCredito" class="form-control form-control-inline input-medium default-date-picker">
                                    ...
                                    <div class="col-4 col-sm-3 col-md-3 col-lg-3 col-xl-3"> 
                                        <div class="form-group form-floating"> 
                                            ...
                                            <button type="button" class="btn btn-primary btn-block" onclick="gestionCreditos();" >Buscar</button>
                                        </div>
                                    </div>
                                        ...
                                        <table id="data" border="0" cellspacing="0" cellpadding="0" class="tablesorter tasktable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="cabecera" >Razón Social / Nombre</td>
                                                    <td class="cabecera" >Crédito Otorgado</td>
                                                    <td class="cabecera" >Solicitante</td>
                                                    <td class="cabecera" >Autorizó</td>
                                                    <td class="cabecera" >Estado</td>
                                                    <td class="cabecera" >Reg.</td>
                                                </tr>
                                            </thead>
                                            <tbody id ="tbodyReporteCreditosComisionistas">
                                                <tr class="even">
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                    ...
                                    <form id="pdfex" name="pdfex" method="post" target="_blank" action="<?php echo $PATHRAIZ; ?>/amp/foreloscomisionista/controllers/gestionCreditosReporte.php" >
                                        <input type="hidden" name="pdf_hnstatusCredito" id="pdf_hnstatusCredito" value="" />
                                    ...
                                    <div class="form-group col-xs-2" style="padding-left:40px;">                             
                                        <form id="excel" name="excel" method="post" target="_blank" action="<?php echo $PATHRAIZ; ?>/amp/foreloscomisionista/controllers/gestionCreditosReporte.php" >
                                        <input type="hidden" name="excel_hnstatusCredito" id="excel_hnstatusCredito" value="" />
    ...
    <script src="<?php echo $PATHRAIZ; ?>/amp/foreloscomisionista/js/gestionCreditos.js?v=<?php echo(rand()); ?>"></script>
        <div class="modal fade" id="consultarComisionista" tabindex="-1" role="dialog" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content"> 
                    <div class="modal-header">
                        <h6 class="modal-title">Registro de Pago de un Crédito</h6>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div> 
                    <div class="modal-body pt-0">
                        <input type="hidden" name="idsMovimiento" id="idsMovimiento">
                        <input type="hidden" name="nIdusuarioRE" id="nIdusuarioRE" value="<?php echo $usuario_logueado;?>">
                        <div class="row"> 
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"> 
                                <div class="form-group form-floating"> 
                                    <label>Nombre /Razón Social del Comisionista</label>
                                    <input type="text" class="form-control m-bot15" id="sRazonSocial" name="sRazonSocial" readonly="readonly" > 
                                </div>
                            </div> 
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"> 
                                <div class="form-group form-floating"> 
                                    <label>Nombre Comercial</label>
                                    <input type="text" class="form-control m-bot15" id="sNombreCadena" name="sNombreCadena" readonly="readonly"  > 
                                </div>
                            </div> 
                        </div>
                        <div class="row"> 
                        ...
                        <div class="row"> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 "> 
                                <div class="form-group form-floating"> 
                                    ...
                                    <input type="text" class="form-control m-bot15" id="nMontoCredito" name="nMontoCredito" readonly="readonly" > 
                                </div>
                            </div>
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 "> 
                                <div class="form-group form-floating"> 
                                    <label>Fecha cuando se otorgó el Crédito</label>
                                    <input type="text" class="form-control m-bot15" id="dFecRegistro" name="dFecRegistro" readonly="readonly" > 
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"> 
                                <div class="form-group form-floating"> 
                                    <label>Quien Autorizó el Crédito</label>
                                    <input type="text" class="form-control m-bot15" id="sNombreAutorizo" name="sNombreAutorizo" readonly="readonly" > 
                                </div>
                            </div> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    <label>Saldo del crédito</label>
                                    <input type="text" class="form-control m-bot15" id="sSaldoCredito" name="sSaldoCredito" readonly="readonly"  > 
                                </div>
                            </div> 
                        </div>
                        <div class="row"> 
                        ...
                        <div class="row"> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    ...
                                    <input type="text" class="form-control m-bot15" id="sMontoPago" name="sMontoPago"   > 
                                </div>
                            </div> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    <label>Saldo despúes de Aplicado el Pago</label>
                                    <input type="text" class="form-control m-bot15" id="sSaldoDespuesPago" name="sSaldoDespuesPago" > 
                                </div>
                            </div> 
                        </div>
                        <div class="row"> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    <label>Ingresar Folio de Recibo</label>
                                    <input type="text" class="form-control m-bot15" id="nFolioRecibo" name="nFolioRecibo"   > 
                                </div>
                            </div> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    <label>Ingresar Fecha de Pago del Recibo</label>
                                    <input type="text" id="fecha" name="fecha" class="form-control form-control-inline input-medium default-date-picker" onpaste="return false" data-date-format="yyyy-mm-dd" maxlength="10" value="<?php echo date("Y-m-d");?>" onkeypress="return validaFecha(event,'fecha2')" onkeyup="validaFecha2(event,'fecha2')">
                                </div>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating">                                     
                                    <button type="button" data-dismiss="modal" class="  btn btn-primary btn-block"  >Cancelar</button>
                                </div>
                            </div> 
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6"> 
                                <div class="form-group form-floating"> 
                                    <button type="button" class="btn btn-primary btn-block" id="BtnCredito" onclick="gestionCreditosValidaPago();" >Registrar Pago</button>                                 
                                </div>
                            </div> 
                        </div>
                    </div> 
