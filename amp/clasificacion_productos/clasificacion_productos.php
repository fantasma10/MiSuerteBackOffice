...
<title>.::Mi Red::.Clasificación Productos</title>
<!-- Núcleo BOOTSTRAP -->
    ...
    <div class="col-lg-12">
        ...
        <div class="panelrgb">
            ...
            <div class="titulorgb-prealta">
                ...
                <h3>Clasificación Productos</h3>
                <span class="rev-combo pull-right">Clasificación <br>Productos</span>
            </div>

            <div class="panel">
                <div class="panel-body">

                    <button id="btnRegistrar" onclick="registrarClasificacion()" class="btn btn-xs btn-info pull-right" style="margin-bottom:10px;"> Registrar</button>
                            ...
                            <table id="data" class="display table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Comisión Cobrada al Emisor</th>
                                        <th>Comisión Pagada al comisionista</th>
                                        <th>Comisión Red Efectiva</th>
                                        <th>Comisión Cobrada al cliente final</th>
                                        <th>Clasifica</th>
                                    </tr>
                                </thead>    
                                <tbody id ="tbodyClasificaProductos">  
                                </tbody>
                            </table>
                        </div>
                    </div>
                    <div class="form-group col-xs-12" id="export">
                        <div class="form-group col-xs-2" style="padding-left:40px;">                                   
                            <form id="excel" name="pdf" method="post" target="_blank" action="<?php echo URL ?>amp/clasificacion_productos/ajax/ReporteClasificacionProductosExport.php">
                        ...
                        <div class="form-group col-xs-2" style="padding-left:40px;">
                            <span class="badge light badge-success"><i class="fa fa-circle text-success"></i> Activo <span class="badge light badge-danger"><i class="fa fa-circle text-danger"></i> Inactivo</span></span>                                   
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo $PATHRAIZ; ?>/amp/clasificacion_productos/js/clasificacion_productos.js?v=<?php echo(rand()); ?>"></script>
