...
class guardar_conf_facturacion_cliente{
    private $nIdFactura;
       ...
       $data=array();
        if($TAE != ''){
            if($this->nIdFactura != ""){
                ...
                $oRAMP->setSStoredProcedure('sp_update_facturacion_cliente');
                ...
                $oRAMP->setSStoredProcedure('sp_insert_facturacion_cliente');
                $oRAMP->setParams($param);
...
$obj = new guardar_conf_facturacion_cliente();
$arrayDataPost=array();
