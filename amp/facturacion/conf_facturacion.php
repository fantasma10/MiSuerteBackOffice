...
<html lang="es">
                                            ...
                                            <li id="btnConsultar" role="presentation" class="active" data-tipocomercio="0">
                                                <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Consultar">
                                                    <span class="round-tab">
                                                        <i class="glyphicon glyphicon-search"></i>  Configuracion de facturación TAE
                                                    </span>
                                                </a>
                                            </li>
    ...
    <script src="<?php echo $PATHRAIZ; ?>/amp/facturacion/js/conf_facturacion.js?v=<?php echo(rand()); ?>"></script>
