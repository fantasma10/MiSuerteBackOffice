    ...
    function getPagos(fecha1,fecha2){
		...
		function(response){		
			...
			jQuery.each(obj, function(index,value) {
				...
				'<td>'+obj[index]['concursante']+'</td><td class="thMonto"> $'+obj[index]['premio']+'</td>'+
				'<td>'+obj[index]['dispersion']+'</td><td class="thMonto"> $'+obj[index]['premioPagado']+'</td>'+
				'<td>'+obj[index]['fechaPago']+'</td><td class="thMonto"> $'+obj[index]['venta']+'</td>'+
