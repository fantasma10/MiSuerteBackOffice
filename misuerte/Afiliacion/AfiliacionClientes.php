...
<head>
	...
	<title>.::Mi Red::.Afiliacion de Clientes</title>
	<!-- Núcleo BOOTSTRAP -->
					...
					<div class="col-lg-12">
						...
						<div class="panelrgb">
							<div class="titulorgb-prealta">
								...
								<h3>Datos del cliente</h3><span class="rev-combo pull-right">Afiliación <br>de Cliente</span>
							</div>
							<div class="panel">
								<div class="panel-body">
									...
									<div class="well">
										...
										<label class="col-xs-4 control-label">Número de Socio: </label>	
										</div>
										<div class="form-group col-xs-12">
											<div class="form-group col-xs-4">
											...
											<div class="form-group col-xs-4">
												<input type="text" id="socioId" class='form-control m-bot15'>
											</div>
										</div>
										</div>
									<div class="well">
										...
										<div class="form-group col-xs-12" style="text-align:right;padding-right:30px;">
											<button class="btn btn-xs btn-info " id="guardarC" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Actualizando" style="margin-top:10px;"> Guardar </button>
										</div>
									</div>
