...
<head>
	...
	<link href="<?php echo $PATHRAIZ;?>/assets/data-tables/DT_bootstrap.css" rel="stylesheet" />
					...
					<div class="col-lg-12">
						...
						<div class="panelrgb">
							<div class="titulorgb-prealta">
								...
								<h3>M&eacute;todos de Pago</h3><span class="rev-combo pull-right">M&eacute;todos <br>de Pago</span>
							</div>
							<div class="panel">
								<div class="panel-body">
									<div class="well">
										<div class="row">
											<div class="col-xs-12">
												<button type="button" id="btnNuevoMetodoPago" class="btn btn-xs btn-info pull-right" style="margin-top:10px;"> Nuevo </button>
											</div>
										</div>
									</div>
		...
		<script src="<?php echo $PATHRAIZ;?>/misuerte/js/MetodoPago_index.js"></script>
		<script>
