...
$subsubmenuTitulo	= "Cuenta Electronica";
...
<head>
	...
	<title>.::Mi Red:: Pagos con Cuenta Electronica</title>
	<!-- Núcleo BOOTSTRAP -->
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $PATHRAIZ;?>/assets/bootstrap-datepicker/css/datepicker.css" />
					...
					<div class="col-lg-12">
						...
						<div class="panelrgb">
							<div class="titulorgb-prealta">
								...
								<h3>Pago con Cuenta Electronica</h3><span class="rev-combo pull-right">Pago con <br>Cuenta Electronica</span>
							</div>
							<div class="panel">
								<div class="panel-body">
									<div class="well">
										<div>
											<h4><span><i class="fa fa-money"></i></span> Pagos con Cuenta Electronica</h4>
										</div>
										<div class="form-group col-xs-12" style="padding-right:0px;">
											...
											<div class="form-group col-xs-12" style="padding-right:0px;">
												...
												<form id="excel" method="post" class="excel" action="../../ajax/excelPagosCuenta.php" >
 												...
 												<table id="tblGridBox" style="display:inline-table;" class="display table table-bordered table-striped">
 													<thead>
 														<tr>
                                                        	...
                                                        	<th id="thFecha">Monto del Monedero Electronico</th>
                                                        	<th id="thFecha">Fecha de Cargo del Monedero Electronico.</th>
                                                        	<th id="thFecha">Ventas de M.E</th>
		...
		<script src="<?php echo $PATHRAIZ;?>/misuerte/js/pagosCuenta.js"></script>
