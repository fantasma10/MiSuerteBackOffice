...
<head>
	...
	<title>.::Mi Red::.Conciliaci&oacute;n</title>
	...
	<link href="<?php echo $PATHRAIZ;?>/assets/data-tables/DT_bootstrap.css" rel="stylesheet" />
					...
					<div class="col-lg-12">
						...
						<div class="panelrgb">
							<div class="titulorgb-prealta">
								...
								<h3>Conciliaci&oacute;n</h3><span class="rev-combo pull-right">Conciliaci&oacute;n<br>&nbsp;</span>
							</div>
							<div class="panel">
								<div class="panel-body">
											...
											<div class="row">
												<div class="col-xs-2">
													<div class="form-group">
														...
														<input type="text" name="dFechaInicio" id="txtFechaInicio" class="form-control" readonly="" value="2016-11-01"/>
													</div>
												</div>
												<div class="col-xs-2">
													<div class="form-group">
														<label>Fecha Final</label>
														<input type="text" name="dFechaFinal" id="txtFechaFinal" class="form-control" readonly="" value="2016-11-05"/>
													</div>
												</div>
												<div class="col-xs-2">
									...
									<div class="col-xs-12">
										<?php
											if($esEscritura){
										?>
										<button type="button" class="btn btn-sm btn-default pull-right" style="margin-top:20px;margin-right:5px;" id="btnConciliar">Conciliar</button>
										<?php
											}
										?>
									</div>
									...
									<div class="col-xs-6">
										<h3>Movimientos</h3>
										<div style="height:500px!important;overflow: auto!important;">
											<table class="display table table-bordered" id="tbl-banco">
												<thead>
													<tr>
														<th></th>
														<th>Fecha</th>
									...
									<div class="col-xs-6">
										<h3>Facturas</h3>
										<div style="height:500px!important;overflow: auto!important;">
											<table class="display table table-bordered" id="tbl-facturas">
												<thead>
													<tr>
														<th></th>
														<th>sFolio</th>
		...
		<script src="<?php echo $PATHRAIZ;?>/misuerte/js/conciliacion/conciliacion.js"></script>
