	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="3">
            <tr>
              ...
              <td width="80%" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td align="center" valign="middle"><img src="../../img/btn_subcadena1.png" width="68" height="68" /><br/>
                    ...
                    <tr>
                      ...
                      <td align="center" valign="middle"><table border="0" cellspacing="0" cellpadding="6">
                            <tr>
                              ...
                              <td align="center" valign="bottom"><a href="#" onclick="BuscaPreSubCadena()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image21','','../../img/btn_busqueda2.png',1)"><img src="../../img/btn_busqueda1.png" alt="" name="Image21" width="30" height="30" border="0" class="boton_busqueda" id="Image21" /></a></td>
                            </tr>
                                            </table></td>
                      <td align="center" valign="middle"><table border="0" cellspacing="0" cellpadding="6">
                        <tr>
                          <td align="center" valign="bottom">Cadena
                            ...
                            <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/btn_busqueda2.png',1)"></a></td>
                          <td align="center" valign="bottom"><a href="#" onclick="BuscaPreSubCadena()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','../../img/btn_busqueda2.png',1)"><img src="../../img/btn_busqueda1.png" alt="" name="Image1" width="30" height="30" border="0" class="boton_busqueda" id="Image1" /></a></td>
                        </tr>
                      </table></td>
                      <td width="25%" align="center" valign="middle">&nbsp;</td>
                    </tr>
...
<script>window.setTimeout("AutoCadenaN()",100);</script>
<script>window.setTimeout("AutoPreSubCadena()",200);</script>
<script>window.setTimeout("BuscarPreSubCadenas()",300);</script>
</body>
	<?php $RBD->close(); ?>
</html>
