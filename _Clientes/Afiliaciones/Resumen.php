									...
									<div class="panel-body">
										...
										<div class="adv-table" id="htmlTbl">
											<!--table class="display table table-bordered table-striped dataTable" id="tblListaCorresponsales" aria-describedby="tblListaCorresponsales_info">
												<thead>
													<tr>
														<th class="first">Sucursal</th>
														<th class="sorting_asc">Referencia</th>
													</tr>
												</thead>
												<tbody role="alert" aria-live="polite" aria-relevant="all">
													<tr class="odd">
														<td>Nombre de la Sucursal</td>
														<td>12345879632258452</td>
													</tr>
												</tbody>
											</table-->
										</div>
										...
										<table class="tc">
		 								...
		 								<a class="noesconsulta" href="Cliente.php?idCliente=<?php echo $idCliente;?>"><button class="btn btn-xs btn-info pull-right"> Finalizar</button></a>
							...
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-xs-1">
										...
										<a href="#" class="btn btn-labeled btn-envio" onClick="enviarCorreo()">
...
<script>
	$(function(){
		...
		ES_SUBCADENA	= "<?php echo $_POST['esSubcadena'];?>";
