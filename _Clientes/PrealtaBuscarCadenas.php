...
<h3>Cadenas</h3><span class="rev-combo pull-right">B&uacute;squeda<br>de Pre Altas</span></div>
<!--<header class="panel-heading">B&uacute;squeda de Pre Altas</header>-->
<div class="panel-body">
                                    <!--Inicio de Tabla Cadena-->
                                    <div class="table-responsive">
                                    <div class="adv-table">
                                    <table class="display table table-bordered table-striped" id="precadenas">
                                      <thead>
                                      <tr>
                                          <th>Nombre</th>
                                          <th>% Avance</th>
...
<script src="../inc/js/_PrealtaPreCadena.js"></script>