...
<h3>Administraci&oacute;n de equipos</h3><span class="rev-combo pull-right" style="text-align: right">Administraci&oacute;n<br />de equipos</span></div>

<div class="panel">

<div class="jumbotron">
      <div class="container">
        <h2>Administraci&oacute;n de equipos</h2>
 ...
 <div class="well">
  <form class="form-horizontal" id="formaBanco" method="post" >                                      
										 ...
										 <input type="hidden" id="idCorresponsal" name="idCorresponsal" />
                                          ...
                                          <br/>
                                       <input class="form-control m-bot15" type="text" placeholder="ID o Nombre del Corresponsal" id="txtCorresponsal">
                                          </div>
...
<script src="<?php echo $PATHRAIZ; ?>/inc/js/AdministracionEquipos.js"></script>
<script src="<?php echo $PATHRAIZ; ?>/inc/js/equipos.js"></script>
<script>
	$(function(){
