...
<head>
	...
	<title>.::Mi Red::.Proveedor Telcel</title>
	<!-- Núcleo BOOTSTRAP -->
	...
	<section class="wrapper site-min-height">
		<div class="panel panelrgb">
			<div class="titulorgb-prealta">
				...
				<h3>Actualización de Proveedor Temporal Telcel</h3>
				<span class="rev-combo pull-right">Actualización<br>Proveedor</span>
			</div>  
			<div class="panel-body panel-tbl-proveedores"> 
				<div class="row" id="first-row-cliente">
					<div class="col-xs-3">
						<div class="form-group">
							<label>Contraseña</label>
							<input type="password" class="form-control" name="sPwd" id="txtSPwd" maxlength="20" />
						</div>
					</div>
					<div class="col-xs-2">
						<button id="btnEntrar" type="button" class="btn btn-sm btn-default pull-left" style="margin-top:20px;">Entrar</button>
					</div> 
				</div> 
			</div>
		</div>
...
<script src="../../inc/js/Proveedores/Telcel/telcel.js"></script>
