...
<body>
				...
				<div class="col-lg-12">
					...
					<div class="panelrgb">
							...
							<div class="panel-body">
								...
								<div id="gridboxExport" class="adv-table table-responsive">
									<div id="gridbox" class="">
										<table id="tabla_proveedores" class="display table table-bordered table-striped" style="width: 100%">
											<thead>
												<tr>
													<th>Id</th>
													<th>RFC</th>
						...
						<div id="bitacoraClientePanel" class="panel" style="display: none;">
							<div class="panel-body">
								<div class="well">
									<div class="form-group col-xs-12" style="display: flex; justify-content: space-between;">
										<h5 class="col-xs-10 control-label" style="padding: 0;">Cliente: <em id='labelID'></em></h5>
										<button id="botonVolverBitacora" class="btn btn-xs btn-info" onclick="volverBitacora()"> Volver </button>
									</div>
									<div class="adv-table table-responsive">
										<table id="bitacoraClienteTable" class="display table table-bordered table-striped">
											<thead>
												<tr>
													<th class="thWidth">Catálogo</th>
													<th class="thWidth">Usuario</th>
													<th class="thWidth">Campo</th>
													<th class="thWidth">Valor anterior</th>
													<th class="thWidth">Valor nuevo</th>
													<th class="fechaCambio">Fecha último cambio</th>
												</tr>
											</thead>
											<tbody>
											</tbody>
		...
		<div class="modal-dialog" style="width:50%;">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Modificar Estatus Proveedor</h4>
				</div>
				<div class="modal-body">
					<p></p>
					<input type="hidden" id="idProveedor" class='form-control m-bot15'>
					<input type="hidden" id="estatusProveedor" class='form-control m-bot15'>
				</div>
	...
	<div id="productos" class="modal fade col-xs-12" role="dialog">
		<div class="modal-dialog" style="width:80%;">
			<div class="modal-content">
				<div class="modal-header">
					<span><i class="fa fa-lightbulb-o" style="font-size:18px"></i> Productos </span>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title"></h4>
				</div>

				<div class="modal-body">
					<div style="font-size:22px" id="nombreProveedor"></div>
					<!-- <div class="row"> -->
					<!-- <div class="panel with-nav-tabs panel-default" style="box-shadow: none;"> -->
					<!-- <div class="panel-heading">
                        <ul class="nav nav-tabs">
                             <li class="active"><a href="#tab1default" data-toggle="tab"><div id="nombreProveedor"></div></a></li>
                         </ul>
                     </div> -->
					<div class="panel-body">
						<div id="gridbox_tabla" style="overflow:auto;">
						</div>
					</div>
					<!-- </div> -->
					<!-- </div> -->
	...
	<script src="<?php echo $PATHRAIZ; ?>/_Proveedores/proveedor/js/consulta.js?v=<?php echo (rand()); ?>"></script>
