...
$submenuTitulo		= "Consulta Ordenes Pago";
$subsubmenuTitulo	= "Consulta Ordenes Pago";
$tipoDePagina = "mixto";
$idOpcion = 210;
...
<html lang="es">
	<head>
		...
		<title>.::Mi Red::.Consulta Ordenes Pago</title>
		<!-- Núcleo BOOTSTRAP -->
						...
						<div class="panel">
							<div class="panel-body">
								<div class="well">
									...
									<div class="form-group col-xs-12">
										<form method="post" id="exportar_excel" action="../ajax/exportarOrdenesPago.php">
	                                        <input type="hidden" name="rfc_excel" id="rfc_excel">
	                                        <input type="hidden" name="estatus_excel" id="estatus_excel">
			                    ...
			                    <div id="gridboxExport" class="adv-table table-responsive" style="overflow-y: auto;">
			                        <div id="gridbox" class="table-responsive">
			                            <table id="tabla_productos" class="table table-bordered table-striped" style="width: 100%;display:none">
			                                <thead>
			                                    <tr>
			                                    	<th>Id</th>                                                    
	...
	<script src="<?php echo $PATHRAIZ;?>/_Proveedores/reportes/js/ordenesPagos.js"></script>
