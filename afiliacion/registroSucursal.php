...
<script src="../css/ui/jquery.ui.menu.js"></script>
    ...
    <script src="./js/jquery.mask.min.js" ></script>
     ...
     <script src="./js/nuevasucursal.js" ></script>
...
<![endif]-->
    ...
    <style>
     ...
     <div id="pdfvisor" style="color:rgba(0, 0, 0, 0.59)">
         <center>
...
<h3>Sucursales Registradas</h3><span id="nuevospn" class="rev-combo pull-right">Nuevo<br>Registro</span></div>
