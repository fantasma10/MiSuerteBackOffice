													...
													<table width="513" cellspacing="0" cellpadding="0" border="0" style="font-family: &#39;Lucida Sans Unicode&#39;,&#39;Lucida Grande&#39;,sans-serif,Arial,Verdana; font-size: 12px;"> 
														...
														<tr>
															<td valign="top">
																...
																<p style="color:#000000;">Se ha creado un NUEVO PROSPECTO y necesita tu atención.</p>  
																<p style="margin-top:20px;">
																	<span style="color:#333;">Nombre del Cliente:</span><br/><span><?php echo utf8_encode($oProspecto->getSRazonSocial());?></span>  
																	<div style="line-height:10px;"><span style="color:#333;">RFC:</span> <span><?php echo $oProspecto->getSRFC();?></span></div>  
																</p> 
															</td>
