											...
											<tr>
												 <td align="center" style="padding-top:25px; padding-bottom:30px;">
													<table width="513" cellspacing="0" cellpadding="0" border="0" style="font-family: &#39;Lucida Sans Unicode&#39;,&#39;Lucida Grande&#39;,sans-serif,Arial,Verdana; font-size: 12px;"> 
														...
														<tr>
															<td valign="top">
																<p style="font-size: 17px; color: #000000; padding-top:5px;"> <span style="color:#305D92;">'.$tipo.'</span></p><br>
                                                                <p style="font-size: 15px; color: #000000; padding-top:5px;"> Sucursal: <span style="color:#1b3655;">'.utf8_encode($sucursal).'</span></p><br>
                                                                <p style="font-size: 14px; color: #000000; padding-top:5px;" <span style="color:#0a111a;">'.utf8_encode($mensaje).'</span></p><br>
                                                                <p style="font-size: 13px; color: #000000; padding-top:5px;">Movimiento echo por : <span style="color:#0d4688;">'.utf8_encode($usuario).'</span> de Red Efectiva.</p><br>
                                                                
                                                                <p style="font-size: 13px; color: #000000; padding-top:5px;">Fecha y Hora: <span style="color:#0d4688;">'.utf8_encode($fecha).'</span></p>
