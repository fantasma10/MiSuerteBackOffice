											...
											<tr>
												<td align="center" style="padding-top:15px; padding-bottom:30px;">
													<table width="513" cellspacing="0" cellpadding="0" border="0" style="font-family: &#39;Lucida Sans Unicode&#39;,&#39;Lucida Grande&#39;,sans-serif,Arial,Verdana; font-size: 12px;"> 
														...
														<tr>
															<td valign="top">
																<p style="font-size: 17px; color: #000000; padding-top:5px;">Hola, <span style="color:#305D92;"> Departamento de Contabilidad</span></p>
																<p style="color:#000000;">Se ha asignado una REFERENCIA BANCARIA al siguiente PROSPECTO.</p>  
																<p style="margin-top:15px;">
																	<span style="color:#333;">Nombre del Prospecto:</span><br/><span><?php echo utf8_encode($oProspecto->getSRazonSocial());?></span>  
																	<div style="line-height:10px;"><span style="color:#333;">Referencia Bancaria:</span> <span><?php echo $oProspecto->getSReferenciaBancaria();?></span></div>  
																</p> 
															</td>
