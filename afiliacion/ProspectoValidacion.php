...
<link href="../assets/advanced-datatable/media/css/demo_table.css" rel="stylesheet" />  
  ...
  <link href="./css/table-responsive.css" rel="stylesheet">
    ...
    <script src="./js/jquery.mask.min.js" ></script>
     ...
     <script src="./js/nuevoclienteAutorizacion.js" ></script>
...
<section class="panel">    
  <div id="content" class="page-content clearfix">
      <div class="heading">
			<!--  .heading-->
            <a href="./autorizacionProspecto.php"><button type="button">Regresar</button></a> 
		
		</div> <br>
      <?php include('./application/views/clientes/afiliacionexpress/modulos/Forelo.php'); ?>
	<div class="contentwrappers">
				...
				<div class="panel-body">  
					<div class="row ">
						<div class="col-xs-2">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="MAHY670331HJI" disabled="" name="sRFC" id="txtRFC" value="<?php echo $rfc; ?>">
							</div>
						</div> 
						<div class="col-xs-2">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-xs-4"> 
							...
							<input type="file" class="hide" style="display:none;" name="sFileRFC" id="txtFileRFC" idtipodoc="2">
							<input type="hidden" class="" name="nIdDocRFC" id="txtIdDocRFC" idtipodoc="2">
						...
						<div class="col-xs-4"> 
							...
							<input type="file" class="hide" style="display:none;" name="sFileComprobanteDomicilio" id="sFileComprobanteDomicilio" idtipodoc="1">
      ...
      <button type="button" class="btn btn-primary btn-sm pull-right btnfin" id="btnReenviarReferencia">Reenviar Referencia</button>
