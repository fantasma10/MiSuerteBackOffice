...
<div class="col-lg-12">
    ...
    <div class="panelrgb">
        ...
        <h3>Facturas</h3><span class="rev-combo pull-right">Consulta<br>de Facturas</span></div>
            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <select name="cmbMes"  autocomplete="off"  id="cmbMes" class="form-control"> 
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    <label>Seleccione Estatus</label>
                                    <select name="cmbYear"  autocomplete="off" id="cmbYear" class="form-control">
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div id="gridboxExport" class="adv-table table-responsive">
                    <div class="form-group col-xs-12" id="export" style="display: none">
                        <div class="form-group col-xs-2" style="padding-left:40px;">										
                            <form id="pdf" name="pdf" method="post" target="_blank" action="<?php echo URL ?>ayddo/ajax/ReporteFacturasExport.php" >
                                <input type="hidden" name="h_nIdProveedor" id="h_nIdProveedor" value="" />
                                <input type="hidden" name="h_nIdEstatus" id="h_nIdEstatus" value="" />
                                <input type="hidden" name="h_Mes" id="h_Mes" value="" />
                                <input type="hidden" name="h_Year" id="h_Year" value="" />
                        ...
                        <div class="form-group col-xs-2" style="padding-left:40px;">										
                            <form id="excel" name="pdf" method="post" target="_blank" action="<?php echo URL ?>ayddo/ajax/ReporteFacturasExport.php" >
                                <input type="hidden" name="h_nIdProveedor" id="h_nIdProveedor" value="" />
                                <input type="hidden" name="h_nIdEstatus" id="h_nIdEstatus" value="" />
                                <input type="hidden" name="h_Mes" id="h_Mes" value="" />
                                <input type="hidden" name="h_Year" id="h_Year" value="" />
                        ...
                        <div class="form-group col-xs-2" style="padding-left:40px;">
                                <form id="excel3" name="excel3" method="post" target="_blank" action="<?php echo URL ?>ayddo/ajax/DetalleFacturasExport.php" >
                                    <input type="hidden" name="h_mesBusqueda" id="h_mesBusqueda" value="" />
                                    <input type="hidden" name="h_cmbProveedores" id="h_cmbProveedores" value="" />
                                    <input type="hidden" name="h_mesString" id="h_mesString" value="" />
                                    <input type="hidden" name="h_tipo" id="h_tipo" value="1" />
                                    <!--<input type="hidden" name="h_ExportExcel" id="h_ExportExcel" value="1"/>-->
                ...
                <div class="row excel" id="detalleOperaciones" style="display: none;">
                    <div class="col-xs-1" style="float: right;margin-right: 90px;">
                       <form id="excel2" name="excel2" method="post" action="<?php echo URL ?>ayddo/ajax/DetalleFacturasExport.php" >
                           <input type="hidden" name="h_mesBusqueda" id="h_mesBusqueda" value="" />
                           <input type="hidden" name="h_cmbProveedores" id="h_cmbProveedores" value="" />
                           <input type="hidden" name="h_mesString" id="h_mesString" value="" />
                           <input type="hidden" name="h_tipo" id="h_tipo" value="0" />
                        ...
                        <table id="tblGridBox2" class="display table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th id="thMonto">RFC</th>
                                    <th id="thMonto">No de orden</th>
                                    <th id="thMonto">Monto</th>
                                    <th id="thMonto">Forma de pago</th>
                                    <th id="thMonto">Comision sin IVA</th>
                                    <th id="thMonto">IVA</th>
                                    <th id="thMonto">Comision Total</th>
                                </tr>   
                            </thead>
                            <tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Liberar Factura</h4>
                    </div>
...
<script src="<?php echo $PATHRAIZ;?>/ayddo/js/reporteFacturas.js?<?php echo rand() ?>"></script>
<script src="<?php echo $PATHRAIZ;?>/ayddo/js/accounting.js"></script>
