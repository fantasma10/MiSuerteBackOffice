...
<title>.::Mi Red::.Reporte detalle del corte para facturación</title>
<!-- Núcleo BOOTSTRAP -->
...
<div class="col-lg-12">
    ...
    <div class="panelrgb">
        ...
        <h3>Reporte detalle del corte para facturación</h3><span class="rev-combo pull-right">Consulta<br>de Reportes</span></div>
                    ...
                    <div class="row">
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <select name="cmbProveedores"  autocomplete="off"  id="cmbProveedores" class="form-control">
                                </select>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <input type="month" name="mes" id="mesBusqueda" class="form-control" placeholder="Selecciona un mes">
                                </select>
                                </div>
                            </div>
                        </div>
                ...
                <div id="gridboxExport" class="adv-table table-responsive">
                        <div class="form-group col-xs-12" id="export" style="display: none">
                            <div class="form-group col-xs-2" style="padding-left:40px;">										
                                <form id="pdf" name="pdf" method="post" target="_blank" action="<?php echo URL ?>ayddo/ajax/ReporteOrdenesCobroExport.php" >
                            ...
                            <div class="form-group col-xs-2" style="padding-left:40px;">										
                                <form id="excel" name="pdf" method="post" target="_blank" action="<?php echo URL ?>ayddo/ajax/ReporteOrdenesCobroExport.php" >
                                    <input type="hidden" name="h_mesBusqueda" id="h_mesBusqueda" value="" />
                                    <input type="hidden" name="h_cmbProveedores" id="h_cmbProveedores" value="" />
                                    <input type="hidden" name="h_mesString" id="h_mesString" value="" />
                                ...
                                <table id="data" class="display table table-bordered table-striped" style=" width: 100%; display:none;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th id="thMonto">Razon Social</th>
                                            <th id="thMonto">No de operaciones</th>
                                            <th id="thMonto">Monto Total  (Comision MP)</th>
                                            <th id="thMonto">IVA (Comision MP)</th>
                                            <th id="thMonto">Total a facturar (Monto total + IVA)</th>
...
<script src="<?php echo $PATHRAIZ;?>/ayddo/js/reporteOrdenesCobro.js"></script>
