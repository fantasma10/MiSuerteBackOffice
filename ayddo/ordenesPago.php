...
<title>.::Mi Red::.Reporte Ordenes de Pago</title>
<!-- Núcleo BOOTSTRAP -->
...
<div class="col-lg-12">
    ...
    <div class="panelrgb">
        ...
        <h3>Ordenes de pago (Proveedor)</h3><span class="rev-combo pull-right">Consulta<br>de Reportes</span></div>
                            ...
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" onpaste="return false;" id="p_dFechaInicio" name="p_dFechaInicio"
                                        class='form-control m-bot15' data-date-format="yyyy-mm-dd" maxlength="10" value="<?php echo $mesPasado; ?>" onKeyPress="return validaFecha(event,'p_dFechaInicio')" onKeyUp="validaFecha2(event,'p_dFechaInicio')">
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
...
<script src="<?php echo $PATHRAIZ;?>/ayddo/js/ordenesPago.js?<?php echo rand() ?>"></script>
