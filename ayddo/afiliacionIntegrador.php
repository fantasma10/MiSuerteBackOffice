...
$IdIntegrador = (isset($_POST['p_IdIntegrador']))?$_POST['p_IdIntegrador']:0;
...
<head>
	...
	<title>.::Mi Red::.Afiliacion de Integrador</title>
	<!-- Núcleo BOOTSTRAP -->
  ...
  <section id="main-content">
	<section class="wrapper site-min-height">
			...
			<div class="col-lg-12">
				...
				<div class="panelrgb">
                        <div class="titulorgb-prealta">
                            ...
                            <h3>Datos del Integrador</h3>
                            <span class="rev-combo pull-right">Afiliación <br>de  Integrador</span>
                        </div>
					<div class="panel">
                                ...
                                <div class="form-group col-xs-12" id="divedit" >
                                            ...
                                            <div class="form-group col-xs-8" style="padding-top:0px;">
                                                        <div class="form-group col-xs-12" style="padding-top:0px;" id="tokendiv" >
                                                                    <div id="divIdIntegrador">
                                                                    <div class="form-group col-xs-4" style="padding-top:0px;">

                                                                        <label class="control-label">Id Acceso: </label>
                                                                        <input type="text" id="p_IdIntegrador" class='form-control m-bot15' maxlength="12" disabled>
                                                                    </div>
                                                                    </div>
                                                                    <div class="form-group col-xs-8" style="padding-top:0px;    ">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-2" style="padding-top:10px;text-align:right">
                      ...
                      <label class=" control-label">Id Emisor: </label>
                        <input type="text" id="p_nIdEmisor" class='form-control m-bot15' maxlength="12"">    
                      </div>
	                      ...
	                      <input type="text" class="form-control m-bot15" name="p_sCodigoPostal" id="p_sCodigoPostal">
                            ...
                            <div class="well">
                                <div style="margin-bottom:30px;" class="form-group col-xs-9">
                                 ...
                                 <div class="form-group col-xs-12">
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input origen="emisor" type="button" id="btnFileEstadoCuenta"  value="Ver Comprobante" idtipodoc="2" onclick="verdocumento(this);" class ="btnfiles">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input origen="emisor" type="button" id="btnFileEstadoCuenta"  value="Ver Comprobante" idtipodoc="1" onclick="verdocumento(this);" class ="btnfiles">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input origen="emisor" type="button" id="btnFileEstadoCuenta"  value="Ver Comprobante" idtipodoc="3" onclick="verdocumento(this);" class ="btnfiles">
                                 ...
                                 <div class="form-group col-xs-12">
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input origen="emisor" type="button" id="btnFileEstadoCuenta"  value="Ver Comprobante"  idtipodoc="4" onclick="verdocumento(this);" class ="btnfiles">
							...
							<div class="well">
                                ...
                                <div class="well" style="padding-right: 0px;padding-left: 0px;">
                                      ...
                                      <div class="form-group col-xs-12">
                                        <div class="form-group col-xs-12" >
                                            <label class="control-label"><input type="checkbox" id="chkcobrotransferencia" value="1" class='m-bot15' step="any" onclick="habilitar1(this);">¿Se cobrará al Integrador por Transferencia? </label>
                                        </div>
                               ...
                               <div class="well" style="padding-right: 0px;padding-left: 0px;">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="form-group col-xs-4">
                                            <label class="control-label">¿Cómo el Integrador Genera sus Referencias? </label>
                                            <select class="form-control m-bot15" name="p_nIdTipoReferencia" id="p_nIdTipoReferencia">
                                               <option value="-1">Seleccione</option>
                                               <option value="1">Referencia Integrador Carga vía Portal 13</option>
                                               ...
                                               <option value="5">Integrador Genera sus Referencias 30</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-xs-4">
                                            <label class="control-label">¿Cómo se notifican los pagos al Integrador? </label>
                                    ...
                                    <div class="form-group col-xs-4">
                                     ...
                                     <div class="form-group col-xs-4">
                                        ...
                                        <select class="form-control m-bot15" name="p_nIdMetodoLinea" id="p_nIdMetodoLinea">
                                           ...
                                           <option value="2">Integrador consulta Pagos</option>
                            ...
                            <div class="row">
                               <div class="form-group col-xs-12" style="text-align:right;padding-right:30px;">
                                    <button class="btn btn-xs btn-info " id="guardarIntegrador" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Actualizando" style="margin-top:10px;"> Guardar </button>
                                   <button class="btn btn-xs btn-info pull-right" id="btnIntegrador" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Actualizando" style="margin-top:10px;display:none" onclick="actualizarintegrador()"> Guardar Cambios</button>
                                </div>
							</div>
                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="tab1default">
                                                    <p><b>Referencia Integrador</b> : se genera la referencia respetando de 1 hasta 9 posiciones de la referencia del emisor. </p>
		...
		<script>
            ...
            var IdCte = <?php  echo $IdIntegrador; ?>;
			cargaintegrador();

			$("#btnback").on('click',function(){
				$('body').append('<form id="aconsulta" method="post" action="./consultaClientesayddo.php"><input type="hidden" value="1" name="consvalor"/></form>');
				$("#aconsulta").submit();
			});
