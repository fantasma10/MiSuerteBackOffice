...
if ($_POST){
    ...
    $idMetodo    =!empty($_POST["h_metodoPago"]) ? $_POST["h_metodoPago"] : 0;
    $fechaIni    =!empty($_POST["h_dFechaInicio"]) ? $_POST["h_dFechaInicio"] : date('Y-m-d');
    $fechaFin      =!empty($_POST["h_dFechaFinal"]) ? $_POST["h_dFechaFinal"] : date('M');
