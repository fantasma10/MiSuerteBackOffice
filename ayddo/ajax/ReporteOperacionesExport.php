	...
	$sumNeto=0;
		$array_params = array(
			...
			foreach ($data as $value) {
				...
				<td align="center">'.$value['nTotalOperaciones'].'</td>
				<td align="center" colspan="2">$'.$value['nTotalMonto'].'</td>
				<td align="center">$'.$value['nTotalComision'].'</td>
				<td align="center" colspan="2">$'.$value['nTotal'].'</td>
			</tr>';   
			}
			...
			<td align="center" colspan="2">$'.number_format($sumImporte,2).'</td>
			<td align="center" >$'.number_format($sumComision,2).'</td>
			<td align="center" colspan="2">$'.number_format($sumNeto,2).'</td>
			</tr>
			</table>
			';     
