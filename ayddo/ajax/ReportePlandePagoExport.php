<?php
  ...
  require_once($_SERVER['DOCUMENT_ROOT']."/inc/lib/dompdf/dompdf_config.inc.php");
    ...
    $_FechaSolicitud=!empty($_POST["h_fechaSolicitud"]) ? $_POST["h_fechaSolicitud"] : date('Y-m-d');
...
//    $data = utf8ize($data);
    ...
    $header= array("RFC","Razon Social","CLABE interbancaria","Saldo disponible","Monto solicitado","Comision por Orden","Total a depositar");//titulos
    $sum =0; 
    $colors = '';
    $i = 0;
    ...
    $reportehtml .= '<tr>
                    ...
                    <tr>
                        <td rowspan="2" colspan="5  " align="left"><span style="font-weight:bold;"></span></td>
                    ...
                    <tr>
                        <td colspan="5  " align="left" style=""><span style="font-weight:bold;">REPORTE DE PLAN DE PAGOS</span></td><td colspan="2" align="right"><span style="font-size:13px;">Colonia Santa Maria</span></td>
                    </tr>
                    <tr>
                        <td colspan="5  "></td><td colspan="2" align="right"><span style="font-size:13px;">Monterrey, N.L. C.P. 64650</span></td>
                    </tr>
                    <tr>
                        <td colspan="5"><span style="font-weight:bold;">Del dia </span><span id="fechaInicial" style="font-weight:bold;">'.$_FechaSolicitud.'</span></td>
                    </tr>
                    <tr>
    ...
    $reportehtml .= '<tr style="font-size:9px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; background-color: #2c2b2b; ">';
      ...
      foreach ($data as $DATA){
        ...
        $reportehtml .= '   <tr style="font-size:11px;'.$colors.'">
                                ...
                                <td align="center">'.$sClabe.'</td>
                                <td align="right">'.$DATA['nSaldo'].'</td>
